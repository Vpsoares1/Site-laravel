            ...
            <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar"
                ...
                <div class="offcanvas-body">
                    <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="#">Coleção de inverno</a>
                        </li>
                        <li class="nav-item">
    ...
    <div id="carouselExample" class="carousel slide" style="margin-top: 80px;">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="COLEÇÃO DE INVERNO.png" class="d-block w-100" alt="...">
            </div>
        </div>
    </div>
    <div class="row">
        ...
        <div class="card bg-transparent" style="width: 28rem; margin-top: 30px; margin-left: 50px;"
            ...
            <div class="card-body">
                ...
                <p class=" card-text" style="color: white;">369,42 R$</p>
                    <a href="pagamento.html" class="btn btn-outline-light">Go somewhere</a>
            </div>
        </div>
        <div class="card bg-transparent" style="width: 28rem; margin-top: 30px; margin-left: 50px;"
            class="col-sm-12 col-md-6 col-lg-4 col-xl-3 col-xxl-2">

                ...
                <div class="offcanvas-body">
                    <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                        ...
                        <li class="nav-item">
                         ...
                         <li class="nav-item">
                            <a class="nav-link" href="filtro.html">Filtrar</a>
                        </li>
                        </li>
                         <li class="nav-item">
                            <a class="nav-link" href="tamanhofiltro.html">Filtrar por tamanho</a>
                        </li>
    ...
    <div class="row">
        ...
        <div class="Moletom col-lg-4">
            <div class="card bg-transparent" style="width: 28rem; margin-top: 30px; margin-left: 50px;"
                ...
                <div class="card-body">
                    <h5 class="card-title" style="color: white;"">Gray FLAME Hoddie</h5>
                <p class=" card-text" style="color: white;">358,89 R$</p>
                        <a href="pagamento.html" class="btn btn-outline-light">Comprar</a>
                </div>
            </div>
        </div>
        ...
        <div class="Moletom col-lg-4">
            <div class="card bg-transparent" style="width: 28rem; margin-top: 30px; margin-left: 50px;"
                ...
                <div class="card-body">
                    <h5 class="card-title" style="color: white;"">Flame Black Hoodie</h5>
                <p class=" card-text" style="color: white;">358,35 R$</p>
                        <a href="pagamento.html" class="btn btn-outline-light">Comprar</a>
                </div>
            </div>
        </div>
        <div class="Shorts col-lg-4">
            <div class="card bg-transparent" style="width: 28rem; margin-top: 30px; margin-left: 50px;"
                ...
                <div class="card-body">
                    <h5 class="card-title" style="color: white;"">Standart Jeans Shorts</h5>
                <p class=" card-text" style="color: white;">150,35 R$</p>
                        <a href="pagamento.html" class="btn btn-outline-light">Comprar</a>
                </div>
            </div>
        </div>
        ...
        <div class="Moletom col-lg-4">
            <div class="card bg-transparent" style="width: 28rem; margin-top: 30px; margin-left: 50px;"
                ...
                <div class="card-body">
                    <h5 class="card-title" style="color: white;"">Gray Camo Hoodie FLAME</h5>
                <p class=" card-text" style="color: white;">370,42 R$</p>
                        <a href="pagamento.html" class="btn btn-outline-light">Comprar</a>
                </div>
            </div>
        </div>
        ...
        <div class="Shorts col-lg-4">
            <div class="card bg-transparent" style="width: 28rem; margin-top: 30px; margin-left: 50px;"
                ...
                <div class="card-body">
                    <h5 class="card-title" style="color: white;"">Navy Blue Shorts</h5>
                <p class=" card-text" style="color: white;">120,81 R$</p>
                        <a href="pagamento.html" class="btn btn-outline-light">Comprar</a>
                </div>
            </div>
        </div>
        <div class="Shorts col-lg-4">
            <div class="card bg-transparent" style="width: 28rem; margin-top: 30px; margin-left: 50px;"
                ...
                <div class="card-body"> <br> <br>
                    <h5 class="card-title" style="color: white;">Track White Jeans FLAME</h5>
                    <p class="card-text" style="color: white;">156,76 R$</p>
                    <a href="pagamento.html" class="btn btn-outline-light">Comprar</a>
                </div>
            </div>
        </div>
        <div class="Moletom col-lg-4">
            <div class="card bg-transparent" style="width: 28rem; margin-top: 30px; margin-left: 50px;"
                ...
                <div class="card-body">
                    <h5 class="card-title" style="color: white;"">Tracksuit Hoodie Original FLAME</h5>
                <p class=" card-text" style="color: white;">369,42 R$</p>
                        <a href="pagamento.html" class="btn btn-outline-light">Comprar</a>
                </div>
            </div>
        </div>
        ...
        <div class="Calça col-lg-4">
            <div class="card bg-transparent" style="width: 28rem; margin-top: 30px; margin-left: 50px;"
                ...
                <div class="card-body">
                    <h5 class="card-title" style="color: white;"">Baggy Black Predator FLAME</h5>
                <p class=" card-text" style="color: white;">365,99 R$</p>
                        <a href="pagamento.html" class="btn btn-outline-light">Comprar</a>
                </div>
            </div>
        </div>
        <div class="Shorts col-lg-4">
            <div class="card bg-transparent" style="width: 28rem; margin-top: 30px; margin-left: 50px;"
                ...
                <div class="card-body">
                    <h5 class="card-title" style="color: white;"">Blood Jeans Shorts FLAME</h5>
                <p class=" card-text" style="color: white;">211,89 R$</p>
                        <a href="pagamento.html" class="btn btn-outline-light">Comprar</a>
                </div>
            </div>
        </div>
        <div class="Moletom col-lg-4">
            <div class="card bg-transparent" style="width: 28rem; margin-top: 30px; margin-left: 50px;"
                ...
                <div class="card-body">
                    <h5 class="card-title" style="color: white;"">UTOPIA Black Hoodie FLAME</h5>
                <p class=" card-text" style="color: white;">380,42 R$</p>
                        <a href="pagamento.html" class="btn btn-outline-light">Comprar</a>
                </div>
            </div>
        </div>
        ...
        <div class="Calça col-lg-4">
            <div class="card bg-transparent" style="width: 28rem; margin-top: 30px; margin-left: 50px;"
                ...
                <div class="card-body">
                    <h5 class="card-title" style="color: white;"">White Track Pants FLAME</h5>
                <p class=" card-text" style="color: white;">315,35 R$</p>
                        <a href="pagamento.html" class="btn btn-outline-light">Comprar</a>
                </div>
            </div>
        </div>
        ...
        <div class="Calça col-lg-4">
            <div class="card bg-transparent" style="width: 28rem; margin-top: 30px; margin-left: 50px;"
                ...
                <div class="card-body">
                    <h5 class="card-title" style="color: white;"">Black Jeans Original FLAME</h5>
                <p class=" card-text" style="color: white;">350,42 R$</p>
                        <a href="pagamento.html" class="btn btn-outline-light">Comprar</a>
                </div>
            </div>
        </div>
        ...
        <div class="Shorts col-lg-4">
            <div class="card bg-transparent" style="width: 28rem; margin-top: 30px; margin-left: 50px;"
                ...
                <div class="card-body">
                    <h5 class="card-title" style="color: white;"">Signature Black Shorts FLAME</h5>
                <p class=" card-text" style="color: white;">199,99 R$</p>
                        <a href="pagamento.html" class="btn btn-outline-light">Comprar</a>
                </div>
            </div>
        </div>
        ...
        <div class="Shorts col-lg-4">
            <div class="card bg-transparent" style="width: 28rem; margin-top: 30px; margin-left: 50px;"
                ...
                <div class="card-body">
                    <h5 class="card-title" style="color: white;"">Black Jorts Standart FLAME</h5>
                <p class=" card-text" style="color: white;">198,89 R$</p>
                        <a href="pagamento.html" class="btn btn-outline-light">Comprar</a>
                </div>
            </div>
        </div>
        <div class="Calça col-lg-4">
            <div class="card bg-transparent" style="width: 28rem; margin-top: 30px; margin-left: 50px;"
                ...
                <div class="card-body">
                    <h5 class="card-title" style="color: white;"">Baggy Black Jeans FLAME</h5>
                <p class=" card-text" style="color: white;">315,35 R$</p>
                        <a href="pagamento.html" class="btn btn-outline-light">Comprar</a>
                </div>
            </div>

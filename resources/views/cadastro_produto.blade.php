...
<div class="container container-sm">
    ...
    <div class="row mt-2 justify-content-center p-3 rounded shadow-sm bg-body-tertiary">
        <div class="col-lg-12 col-sm-12 col-md-10">
            ...
            <input type="text" class="form-control form-control-sm" id="nome_produto" name="nome_produto" 
            placeholder="Digite o nome do produto">
        </div>
        <div class="col-lg-12 col-sm-12 col-md-10 mt-2">
            <label for="descricao_produto">Descrição do Produto</label>
            <textarea class="form-control form-control-sm" id="descricao_produto" name="descricao_produto"
        ...
        <div class="col-lg-3 col-md-3 col-sm-5 mt-2 justify-content-center d-flex">
